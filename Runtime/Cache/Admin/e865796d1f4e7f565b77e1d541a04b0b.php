...
<body>
	...
	<form action="/index.php?s=/admin/config/edit/id/26.html" method="post" class="form-horizontal">
		<div class="form-item">
		...
		<div class="form-item">
			<label class="item-label">配置分组<span class="check-tips">（配置分组 用于批量设置）</span></label>
			<div class="controls">
				<select name="group">
	...
	<script type="text/javascript">
		...
		//导航高亮
		$('.side-sub-menu').find('a[href="<?php echo U('Config/index');?>"]').closest('li').addClass('current');
	</script>
