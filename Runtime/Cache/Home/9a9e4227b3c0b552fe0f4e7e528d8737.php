...
<div id="main-container" class="container">
    <div class="row">
      ...
      <div class="span9">
        ...
        <section id="contents">
        <ul class="thumbnails">
        	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li class="span2" style="height:280px;">
